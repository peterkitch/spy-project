...
paths, and current sprint state are documented in **project/CLAUDE.md**.

All agents (Claude Code, Codex, Cursor, Aider, or others) should read
project/CLAUDE.md before any code modification, test run, or repository
action. CLAUDE.md is the single source of truth for:
